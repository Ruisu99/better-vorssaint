...
extension CommandBarFeatureStrings {
    static let enUS = CommandBarFeatureStrings(
        ...
        positionCaption: "Drag the mark at the left of the field to move the bar for this opening. The next hotkey puts it back on the default spot. Double-click the mark to recenter it now.",
    ...
    static let ptBR = CommandBarFeatureStrings(
        ...
        positionCaption: "Arraste a marca à esquerda do campo para mover a barra nesta abertura. O próximo atalho a devolve ao lugar padrão. Clique duas vezes na marca para recentralizá-la agora.",
    ...
    static let tr = CommandBarFeatureStrings(
        ...
        positionCaption: "Bu açılışta taşımak için alanın solundaki işareti sürükleyin. Sonraki kısayol çubuğu varsayılan konuma geri koyar. Şimdi ortalamak için işarete çift tıklayın.",
    ...
    static let ru = CommandBarFeatureStrings(
        ...
        positionCaption: "Перетащите значок слева от поля, чтобы сдвинуть панель в этом открытии. Следующий хоткей вернёт её на место по умолчанию. Двойной щелчок по значку центрирует её сейчас.",
    ...
    static let es = CommandBarFeatureStrings(
        ...
        positionCaption: "Arrastra la marca a la izquierda del campo para mover la barra en esta apertura. El siguiente atajo la vuelve a poner en el sitio por defecto. Doble clic en la marca para centrarla ahora.",
    ...
    static let de = CommandBarFeatureStrings(
        ...
        positionCaption: "Ziehe das Zeichen links vom Feld, um die Leiste für diese Öffnung zu verschieben. Beim nächsten Hotkey liegt sie wieder auf der Standardposition. Doppelklick aufs Zeichen zentriert sie sofort.",
    ...
    static let it = CommandBarFeatureStrings(
        ...
        positionCaption: "Trascina il segno a sinistra del campo per spostare la barra in questa apertura. La prossima scorciatoia la rimette nella posizione predefinita. Doppio clic sul segno per centrarla ora.",
    ...
    static let ja = CommandBarFeatureStrings(
        ...
        positionCaption: "入力欄の左のマークをドラッグすると、今回の表示だけバーを動かせます。次のホットキーでは標準位置に戻ります。今すぐ中央に戻すにはマークをダブルクリックします。",
    ...
    static let ko = CommandBarFeatureStrings(
        ...
        positionCaption: "입력란 왼쪽 표식을 드래그하면 이번 열림에서만 막대를 옮길 수 있습니다. 다음 단축키에서는 기본 위치로 돌아갑니다. 지금 가운데로 돌리려면 표식을 두 번 클릭하세요.",
    ...
    static let zhHans = CommandBarFeatureStrings(
        ...
        positionCaption: "拖动输入框左侧的标志，可以在本次打开时移动命令栏。下次快捷键会把它放回默认位置。双击标志可立即居中。",
    ...
    static let zhTW = CommandBarFeatureStrings(
        ...
        linkAddButton: "加入捷徑",
        positionCaption: "拖曳輸入欄左側的標誌，可以在這次開啟時移動指令列。下次快捷鍵會把它放回預設位置。雙按標誌可立即置中。",
    ...
    static let zhHK = CommandBarFeatureStrings(
        ...
        scriptBareSearchHint: "可直接執行，或輸入要傳送的內容",
        linkAddButton: "加入捷徑",
        positionCaption: "拖曳輸入欄左側嘅標誌，可以喺呢次打開時移動指令列。下次快捷鍵會將佢放返預設位置。雙擊標誌可以即刻置中。",
        resetPositionButton: "指令列置中",
