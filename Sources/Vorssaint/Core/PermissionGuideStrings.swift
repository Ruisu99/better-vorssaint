...
struct PermissionGuideStrings {
    ...
    /// left by an earlier copy or by official Vorssaint, which macOS shows
    /// as on but no longer honours. `%@` is the running app name.
...
extension PermissionGuideStrings {
    static let ko = PermissionGuideStrings(
        ...
        stepToggle: "그 목록에서 %@를 켜세요.",
        stepReturn: "여기로 돌아오세요. 이 카드가 자동으로 확인합니다.",
        waiting: "권한을 기다리는 중…",
        granted: "권한이 허용되었습니다!",
        closeHelp: "닫기",
        staleHint: "목록에서 이미 켜져 있나요? 그 스위치는 이전 사본이거나 공식 Vorssaint일 수 있습니다. %@를 켜세요. 화면 기록은 다시 실행한 뒤에만 적용됩니다.",
        startOver: "다시 시작",
...
extension PermissionGuideStrings {
    static let enUS = PermissionGuideStrings(
        ...
        stepToggle: "Turn %@ on in that list.",
        stepReturn: "Come back. This card notices by itself.",
        waiting: "Waiting for the permission…",
        granted: "Permission granted!",
        closeHelp: "Close",
        staleHint: "Already on in that list? That switch may belong to an earlier copy or to official Vorssaint. Turn %@ on. Screen Recording only applies after a relaunch.",
    ...
    static let ptBR = PermissionGuideStrings(
        ...
        stepToggle: "Ligue o %@ nessa lista.",
        stepReturn: "Volte para cá. Este cartão percebe sozinho.",
        waiting: "Esperando a permissão…",
        granted: "Permissão concedida!",
        closeHelp: "Fechar",
        staleHint: "Já está ativado nessa lista? Esse interruptor pode ser de uma cópia anterior ou do Vorssaint oficial. Ligue o %@. A gravação de tela só vale depois de reabrir.",
        startOver: "Recomeçar",
    ...
    static let tr = PermissionGuideStrings(
        ...
        stepToggle: "O listede %@ uygulamasını açın.",
        stepReturn: "Buraya dönün. Bu kart kendiliğinden fark eder.",
        waiting: "İzin bekleniyor…",
        granted: "İzin verildi!",
        closeHelp: "Kapat",
        staleHint: "Bu listede zaten açık mı? O anahtar eski bir kopyaya veya resmi Vorssaint’e ait olabilir. %@ uygulamasını açın. Ekran kaydı ancak yeniden başlatınca geçerli olur.",
    ...
    static let ru = PermissionGuideStrings(
        ...
        stepToggle: "Включите %@ в этом списке.",
        stepReturn: "Вернитесь сюда. Карточка заметит сама.",
        waiting: "Ожидание разрешения…",
        granted: "Разрешение получено!",
        closeHelp: "Закрыть",
        staleHint: "Уже включено в этом списке? Этот переключатель может относиться к прежней копии или к официальному Vorssaint. Включите %@. Запись экрана действует только после перезапуска.",
    ...
    static let es = PermissionGuideStrings(
        ...
        stepToggle: "Activa %@ en esa lista.",
        stepReturn: "Vuelve aquí. Esta tarjeta lo nota sola.",
        waiting: "Esperando el permiso…",
        granted: "¡Permiso concedido!",
        closeHelp: "Cerrar",
        staleHint: "¿Ya está activado en esa lista? Ese interruptor puede ser de una copia anterior o de Vorssaint oficial. Activa %@. La grabación de pantalla solo aplica tras reiniciar.",
    ...
    static let de = PermissionGuideStrings(
        ...
        stepToggle: "Schalte %@ in dieser Liste ein.",
        stepReturn: "Komm zurück. Diese Karte merkt es von selbst.",
        waiting: "Warten auf die Berechtigung…",
        granted: "Berechtigung erteilt!",
        closeHelp: "Schließen",
        staleHint: "In der Liste schon eingeschaltet? Dieser Schalter kann zu einer älteren Kopie oder zu Vorssaint gehören. Schalte %@ ein. Bildschirmaufnahme gilt erst nach einem Neustart.",
    ...
    static let fr = PermissionGuideStrings(
        ...
        stepToggle: "Activez %@ dans cette liste.",
        ...
        closeHelp: "Fermer",
        staleHint: "Déjà activé dans cette liste\u{00A0}? Cet interrupteur peut appartenir à une copie précédente ou à Vorssaint officiel. Activez %@. L’enregistrement d’écran ne s’applique qu’après un relancement.",
    ...
    static let it = PermissionGuideStrings(
        ...
        stepToggle: "Attiva %@ in quell’elenco.",
        stepReturn: "Torna qui. Questa scheda se ne accorge da sola.",
        waiting: "In attesa del permesso…",
        granted: "Permesso concesso!",
        closeHelp: "Chiudi",
        staleHint: "Già attivo in quell’elenco? Quel tasto può appartenere a una copia precedente o a Vorssaint ufficiale. Attiva %@. La registrazione schermo vale solo dopo un riavvio.",
    ...
    static let ja = PermissionGuideStrings(
        ...
        stepToggle: "そのリストで%@をオンにしてください。",
        stepReturn: "ここに戻ってください。このカードが自動で気づきます。",
        waiting: "許可を待っています…",
        granted: "許可されました！",
        closeHelp: "閉じる",
        staleHint: "リストではすでにオンになっていますか？その項目は以前のコピーまたは公式Vorssaintのものです。%@をオンにしてください。画面収録は再起動後に有効になります。",
        startOver: "やり直す",
        relaunch: "再起動して適用"
    )
    ...
    static let zhHans = PermissionGuideStrings(
        ...
        granted: "权限已授予！",
        closeHelp: "关闭",
        staleHint: "列表里已经打开了？那条记录可能属于早期副本或官方 Vorssaint。请开启 %@。屏幕录制须重新启动后才生效。",
        startOver: "重新开始",
        relaunch: "重新启动以生效"
    )
    ...
    static let zhTW = PermissionGuideStrings(
        ...
        granted: "已授予權限！",
        closeHelp: "關閉",
        staleHint: "清單裡已經開啟了？那筆項目可能屬於早期副本或官方 Vorssaint。請開啟 %@。螢幕錄製須重新啟動後才會生效。",
        startOver: "重新開始",
        relaunch: "重新啟動以套用"
    )
