...
extension DictationFeatureStrings {
    ...
    static let fr = DictationFeatureStrings(
        ...
        parakeetModelLabel: "Modèle : mlx-community/parakeet-tdt-0.6b-v3",
        parakeetInstalled: "Parakeet est installé.",
        parakeetNotInstalled: "Parakeet n'est pas installé.",
        parakeetInstallHint: "Installez-le depuis le Terminal, puis vérifiez à nouveau : pip install parakeet-mlx",
