...
extension AppFeature {
    ...
    func hubTitle(_ s: Strings, hub: FeatureHubStrings) -> String {
        ...
        case .menuBarCollapse: return FeatureStrings.menuBarCollapse(L10n.shared.language).title
        }
    }
    ...
    func hubDescription(_ hub: FeatureHubStrings) -> String {
        ...
        case .menuBarCollapse: return FeatureStrings.menuBarCollapse(L10n.shared.language).hubDescription
        }
    }
}
