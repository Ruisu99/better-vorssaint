        ...
        return [
            (categories.essentials, [
                ...
                SettingsDirectoryItem(page: .energy, title: s.tabEnergy, icon: "bolt.fill",
                                       featureKeywords: [
                                        ...
                                        (.displayModes, [FeatureStrings.displayModes(language).pageTitle,
                                                         FeatureStrings.displayModes(language).enable,
                                                         FeatureStrings.displayModes(language).hidpiBadge]),
                                       ]),
            ...
            (categories.utilities, [
                ...
                SettingsDirectoryItem(page: .dictation,
                                      ...
                                      icon: "waveform",
                                      keywords: ["speech to text", "voice typing", "whisper",
                                                 "parakeet", "microphone",
                                                 FeatureStrings.dictation(language).engineApple,
                                                 FeatureStrings.dictation(language).engineOpenAI,
                                                 FeatureStrings.dictation(language).engineParakeet]),
